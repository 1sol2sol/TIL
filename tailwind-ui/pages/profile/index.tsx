    ...
    <Layout hasTabBar title="나의 캐럿">
      ...
      <div className="mt-10 flex justify-around">
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm text-gray-700 font-medium mt-2">판매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
            <svg
          ...
          <span className="text-sm text-gray-700 font-medium mt-2">구매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
            <svg
          ...
          <span className="text-sm text-gray-700 font-medium mt-2">관심목록</span>
        </div>
      </div>
      <div className="mt-12">
