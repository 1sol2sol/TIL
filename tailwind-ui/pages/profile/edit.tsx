    ...
    <div className="py-10 px-4 space-y-4">
      ...
      <div className="space-y-1">
        ...
        <div className="flex rounded-md shadow-sm">
          <span className="flex items-center rounded-l-md justify-center px-3 border border-r-0 border-gray-300 bg-gray-50 text-gray-500 select-none text-sm">
            +82
          </span>
          <input
            id="input"
      ...
      <button className="mt-5 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-3 border-transparent rounded-md shadow-sm font-medium text-sm focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">
        Update profile
      </button>
    </div>
  );
